...
public class MainActivity extends AppCompatActivity {
    ...
    private void init() {
        listConversation = findViewById(R.id.listMainChat);
        edCreateMessage = findViewById(R.id.edCreateMessage);
        ...
        if (requestCode == LOCATION_PERMISSION_REQUEST) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                new AlertDialog.Builder(context)
                        ...
                        .setNegativeButton("Deny", (DialogInterface.OnClickListener) (dialogInterface, i) -> MainActivity.this.finish()).show();
            }
        } else {
